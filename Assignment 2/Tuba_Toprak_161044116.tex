...
\begin{figure*}[htp]
	\centering
	\includegraphics[scale=0.5]{ayrik.png}
	\caption{Solution }
	\label{fig: ayrik}
...
\solution
\newline
Since there is more than one maximal item, there is no largest item.
\newline
...
\newline
 ...
 \newline
\newline
The least upper bound is an upper bound that is less than every other upper bound. so  $\{$2,4$\}$ is the least upper bound.
\newline
