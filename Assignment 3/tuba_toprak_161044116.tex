...
\solution
\newline
To form the adjacency list of a directed graph, we list, for each vertex in the graph, the terminal vertex of each edge that has the given vertex as its initial vertex. 
\newline
\newline
 initial vertices \quad -\quad terminal vertices
\newline
a \quad \quad \quad \quad \quad\quad\quad - \quad \quad b,d 
\newline
b \quad \quad \quad \quad \quad\quad\quad - \quad \quad a,c,d,e
\newline
c \quad \quad \quad \quad \quad\quad\quad - \quad \quad c,b
\newline
d \quad \quad \quad \quad \quad\quad\quad - \quad \quad a,e
\newline
e \quad \quad \quad \quad \quad\quad\quad - \quad \quad e,c
\newline
\newpage
...
\newline
the graph G1 is not hamilton circuit because A Hamilton circuit is a circuit that visits every vertex once with no repeats. Being a circuit, it must start and end at the same vertex. the circuit that visits every vertex with repeats. These eight edges (a,b,c,h,g,f,e,d) already complete a circuit, and this circuit omits the nine vertices on the inside. Therefore there is no Hamilton circuit
\subproblem{b} \solution
\newline 
the grapgh G2 is not hamilton circuit. because Being a circuit, it must start and end at the same vertex For example, when  circuit reached vertex g, it would have nowhere to go.

\subproblem{c} \solution
\newline
The graph G3 is a hamilton circuit.this circuit could be notated by the sequence of vertices visited, starting and ending at the same vertex: b,a,d,g,h,e,i,f,c,b or a,d,g,h,e,i,f,c,b,a or ..
\newpage
...
\newline
	\begin{subfigure}[h]{0.5\textwidth}
		\centering
		\includegraphics[height=2.8in]{problem3.png}
		\caption{The graph $G_3$}
		\label{fig:G1c}
	\end{subfigure}   CSE273
\newline
there are 5 colors.
\newline
 points 3 for math101
\newline
 points 2 for math243
 \newline
 points 2 for cse211
 \newline
 points 2 for cse333
